...
def main():
    ...
    'Huggy', 'Ignatious', 'Jimbo', "Joe 'Pottin Soil'", 'Johnny', 'Lemongrass', 'Lil Debil', 
    'Longbranch', '"Lunch Money"', 'Mergatroid', '"Mr Peabody"', 'Oil­Can', 'Oinks', 'Old Scratch', 
    'Ovaltine', 'Pennywhistle', 'Pitchfork Ben', 'Potato Bug', 'Pushmeet','Rock Candy', 'Schlomo', 
    'Scratchensniff', 'Scut', "Sid 'The Squirts'", 'Skidmark', 'Slaps', 'Snakes', 'Snoobs', 'Snorki', 
    ...
    'Sugar­Gold', 'Swackhamer', 'Tippins', 'Turnipseed', 'Vinaigrette', 'Walkingstick', 'Wallbanger', 
    ...
    while True:
        ...
        print("\n\n")
        print(Fore.RED+f"{first_name} {last_name}", file=sys.stderr)

        replay = input(Fore.WHITE+"Hit 'Q-key' to Quit or 'Enter-key' to Replay: ")
        if replay.lower() == 'q':
            break
